import React, {ChangeEvent, SyntheticEvent, useContext, useState, useEffect} from 'react';
import { IonCardHeader, IonContent, IonHeader, IonInput, IonPage, IonTitle, IonToolbar, IonCard, IonItem, IonLabel, IonButton } from '@ionic/react';
import './Tab1.css';
      ...
      <IonContent fullscreen>
        ...
        <IonCard>
			...
			<IonItem>
				...
				<IonInput value={text} onIonChange={(e: CustomEvent) => handleInput(e.detail.value)} type="number" />
			</IonItem>
